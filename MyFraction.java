...
public class MyFraction implements MyFractionComparable {
    ...
    public int compareTo(MyFraction another) {
        // So sánh bằng cách cross multiply: a/b vs c/d => a*d vs b*c
        long leftValue = (long) this.numerator * another.denominator;
        long rightValue = (long) another.numerator * this.denominator;
